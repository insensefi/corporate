...
Scenario: One SEPA payment with international RF reference
    Given payment group "2013-11-01-G1" with pending payments
      | end-to-end-id             | name           | iban               | bic           | due-date   | sum    | currency | reference-number |
      | 2013-11-01-134123412      | John Doe       | FI6329501800020582 | BANKFIHH      | 2013-11-15 | 100.01 | EUR      | RF81123453       |
    ...
    <Document xmlns="urn:iso:std:iso:20022:tech:xsd:pain.001.001.03"
      ...
      <CstmrCdtTrfInitn>
        ...
        <PmtInf>
          ...
          <PmtMtd>TRF</PmtMtd>
          <ReqdExctnDt>2013-11-01</ReqdExctnDt>
          <Dbtr>
            <Nm>Oy Company Ab</Nm>
          </Dbtr>
          <DbtrAcct>
